...
"""Four-wave TN256 mid-batch gate/up with explicitly pinned AGPR C.
...
def compile_moe_gemm1_mid(*, H, I, E, BLOCK_M=32, prefetch=3):
    ...
    @flyc.kernel(name=f"gemm1_a4w4_mid_agpr_wide_h{H}_i{I}_e{E}_bm{BM}_pf{prefetch}", known_block_size=[256, 1, 1])
    def kernel(
