...
"""Middle-batch gate/up with K-step offsets in the scalar address operand.
...
def compile_moe_gemm1_mid(*, H, I, E, BLOCK_M=32, prefetch=3):
    ...
    @flyc.kernel(name=f"gemm1_a4w4_mid_soffset_h{H}_i{I}_e{E}_bm{BM}_pf{prefetch}", known_block_size=[256, 1, 1])
    def kernel(
