...
g1_kw = dict(
    ...
    act="swigluoai", alpha=ALPHA, swiglu_limit=LIMIT, w_layout=args.w_layout,
)
g2_kw = dict(
...
tag = (f"g1 bm{BM} tn{args.g1_tile_n} tk{args.g1_tile_k} kw{args.k_wave} nt{args.g1_b_nt} xcd{args.g1_xcd}"
