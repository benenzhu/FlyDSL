...
"""Persistent decode GEMM with a joint gate/up slice-K reduction.
...
def compile_gemm1_persist(
    *, D_HIDDEN, D_INTER, NE, TOPK, BM=16, TILE_N=32, TILE_K=128,
    ...
    @flyc.kernel(name=f"gemm1_a16w4_persist_fused_reduce_h{K}_i{I}_e{NE}_pf{prefetch}_{w_layout}_nt{b_cache_mod}", known_block_size=[256, 1, 1])
    def kernel(
